...
<input id="token" type="text" value={{csrf_token()}} style="display:none;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($data->validate)
                                            <td>
                                                <span class="switch">
                                                    <input type="checkbox" class="switch-sm" id="{{'change-toggle-' . $i}}" value="{{$data->id}}" checked>
                                                    <label for="{{'change-toggle-' . $i}}"></label>
                                                    <?php $i++; ?>
                                                </span>
                                            </td>
                                        @else
                                            <td>
                                                <span class="switch">
                                                    <input type="checkbox" class="switch-sm" id="{{'change-toggle-' . $i}}" value="{{$data->id}}">
                                                    <label for="{{'change-toggle-' . $i}}"></label>
                                                    <?php $i++; ?>
                                                </span>
                                            </td>
...
@section('javascript')
    ...
    //Custom script
    $(document).ready(function() {
        $(".switch-sm").click(function(event) {
            var temp_announcement_id = event.target.value;
            ...
            $.ajax({
                url: '/validate-announcement',
                type : 'POST',
                data: {
                    announcement_id: temp_announcement_id,
